...
For large projects, you can break instructions into topic-specific files using project rules in `.claude/rules/`. Rules let you scope instructions to specific file types or subdirectories.
...
2. Deploy with your configuration management system (MDM, Group Policy, Ansible, or similar tools).
